...
<iframe width="560" height="315" src="https://www.youtube.com/embed/mE2yV77rxVw?si=M86LjHZcc8_fXrgf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen="allowFullScreen"></iframe>
</Callout>
...
Create a Community Token DAO in Dabra.

![](../source/civicpass/civicpass1.png)
...
![](../source/civicpass/civicpass2.png)
...
![](../source/civicpass/civicpass3.png)
...
![](../source/civicpass/civicpass4.png)
...
![](../source/civicpass/civicpass5.png)
...
However, the Dabra UI does not yet expose this feature. If you are interested in using the **Civic Pass** plugin with an NFT Community **DAO**, please [**contact Civic**](https://www.civic.com/contact-us/) or visit the [**Discord**](https://discord.gg/8H5Kdtr5Wn).&#x20;
</Callout>
</Steps>
